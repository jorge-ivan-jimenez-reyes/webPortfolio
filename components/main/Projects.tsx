  ...
  return (
    <>
      ...
      <section
        ...
        className="flex flex-col items-center justify-center gap-12 py-20 relative overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black"
      >
        <h1 className="text-[40px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-blue-500 mb-16">
          Mobile Projects
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-5 justify-center max-w-7xl mx-auto">
          <ProjectCard
            ...
            description="Developed a cross-platform mobile application for e-commerce that enables users to browse and purchase products with an intuitive user interface."
            techStack="React Native, Firebase, Stripe API"
            impact="Increased user engagement by 30% through seamless mobile shopping experience."
          />
          <ProjectCard
            src="/fitnessapp.png"
            title="Fitness Tracker App"
            description="Built a fitness tracker app for iOS and Android that allows users to monitor workouts, track progress, and set fitness goals."
            techStack="Swift, Kotlin, HealthKit, Firebase"
            impact="Helped users track their fitness activities with a 95% satisfaction rate."
          />
          {/* Añade más proyectos móviles aquí */}
        </div>
      </section>
    </>
  );
